  ...
  theme: {
    extend: {
      colors: {
        ...
        /** Fondo amplio de reservas + staff (más oscuro) */
        surface: { DEFAULT: "#D4C4B0", muted: "#CEC0AD" },
        /** Tarjetas y formularios (más claro que surface) */
        panel: { DEFAULT: "#E8DDD0", head: "#DFDBD0" },
